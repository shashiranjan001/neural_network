...
w34  = np.random.uniform(low =-1, high =1, size=(1,51))
...
def backward_pass(out2, out3, out4, sum2, sum3, sum4, output, input_mat, w12, w23, w34, k, alpha):
    ...
    error4_out = -2*(output[k] - out4)*sigmoid_derivative(out4)
...
for i in range(epochs):
    ...
    test_error = test_error/test_input.shape[0]
